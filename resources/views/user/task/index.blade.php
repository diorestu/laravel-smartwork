        ...
        <div>
            @forelse($data as $item)
                <div class="alert alert-secondary alert-top-border fade show mb-3" role="alert">
                    <i class="fa fa-info-circle text-primary align-middle me-3"></i><strong>{{ tglIndo2($item->tanggal_kgt) }}</strong>- {{ $item->title_kgt }}
                </div>
            @empty
                <div class="card rounded py-5 rounded">
                    <div class="d-flex justify-content-center align-self-center">
                        <div class="text-center">
                            ...
                            <br>
                            <a class="fw-bold btn btn-primary py-1 mt-2" href="{{ route('kegiatan.create') }}">Tambah Pengajuan Kegiatan</a>
                        </div>
                    </div>
                </div>
            @endforelse
