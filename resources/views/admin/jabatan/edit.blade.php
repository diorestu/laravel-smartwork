                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group mb-4">
                                                <label for="nip" class="font-weight-bolder">Nama Jabatan <span class="text-danger">*</span></label>
                                                <input required id="jabatan_title" class="form-control" type="text" name="jabatan_title" value="{{ $data->jabatan_title }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group mb-4">
                                                <label for="tanggal_mulaiKerja">Jumlah Tunjangan <span class="text-danger">*</span></label>
                                                <input required id="jabatan_tunjangan" class="form-control" type="number" name="jabatan_tunjangan" value="{{ $data->jabatan_tunjangan }}">
                                            </div>
                                        </div>
                                    </div>
