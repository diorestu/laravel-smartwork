        ...
        <div class="col-12">
            <div class="page-title-box pb-2 d-sm-flex align-items-start justify-content-between">
                <div>
                    ...
                    <p class="text-muted mt-1 text-opacity-50">Berikut adalah daftar semua data jabatan</p>
                </div>
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <div class="btn-group mx-2" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1" style="">
                                <a class="dropdown-item" href="{{ route("jabatan.ekspor") }}">File Excel</a>
                            </div>
                        </div>
                    ...
                    <tbody>
                        @foreach ($data as $i)
                            <tr>
                                ...
                                <td class='text-primary font-weight-bolder'>{{ $i->jabatan_title }}</td>
                                <td>{{ rupiah($i->jabatan_tunjangan) }}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                            <li><a class="dropdown-item" href='{{ route('jabatan.edit', $i->jabatan_id) }}'>
                                                <span><i class="fas fa-edit icon-sm"></i></span>&nbsp;
                                                Edit
                                            </a></li>
                                            <li><a id="{{ $i->jabatan_id }}" href="javascript:void(0);" class="remove dropdown-item text-danger"><i class="fa fa-trash text-danger me-2"></i><b>Hapus</b></a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
        ...
        $(document).ready(function() {
            ...
            $('#myTable').on('click', '.remove', function() {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menghapus jabatan ini? Data yang sudah dihapus tidak bisa dikembalikan.',
                    icon: 'question',
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ url('master/tunjangan/jabatan') }}" + '/' + idStaff;
                        $.ajaxSetup({
                        ...
                        $.ajax({
                            ...
                            success: function(result)
                            {
                                if (result == "ok") {
                                    ...
                                    Swal.fire('Berhasil', 'Berhasil menghapus jabatan', 'success')
                                } else {
