                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <div class="btn-group mx-2" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1" style="">
                                <a class="dropdown-item" href="{{ route("sertifikasi.ekspor") }}">File Excel</a>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    <form action="{{ route('sertifikasi.store') }}" method="post">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-4 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input required class="form-control" type="number" id="sertifikasi_tunjangan" name="sertifikasi_tunjangan">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-success btn-block w-100 font-weight-bolder"><i class="fa fa-plus icon-sm"></i> Tambah Data Sertifikasi</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
