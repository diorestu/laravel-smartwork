                                ...
                                <div class="modal-content">
                                    <form action="{{ route('masa-kerja.store') }}" method="post">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-4 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input required class="form-control" type="number" id="masa_kerja_tunjangan" name="masa_kerja_tunjangan">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-block w-100 btn-success font-weight-bolder"><i class="fa fa-plus icon-sm"></i>Tambah Data Masa Kerja</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
