        ...
        <div class="col-12">
            <div class="page-title-box pb-2 d-sm-flex align-items-start justify-content-between">
                <div>
                    ...
                    <h4 class="mb-sm-0 fw-bold font-size-22 mt-3">Data Pengguna Terdaftar</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <textarea id="my-textarea" class="form-control" name="alamat" rows="5"></textarea>
                                                        </div>
                                                        <div class="mb-2">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover" id="myTable">
                    ...
                    <tbody>
                        @foreach ($data as $i)
                            <tr>
                                <td class='text-primary font-weight-bolder'>{{ $i->id }}</td>
                                <td>{{ $i->nama }}</td>
                                <td><span class="fw-bold">-</span></td>
                                {{-- <td>{{ $i->email }}</td> --}}
                                <td>{{ $i->phone }}</td>
                                <td>{{ $i->username }}</td>
                                <td><span class="badge rounded-pill bg-success">{{ $i->status }}</span></td>
                                <td>
                                    <div class="dropdown">
