            ...
            <div class="page-title-box pb-2 d-sm-flex align-items-start justify-content-between">
                <div>
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route("kpi-master.index") }}">KPI</a></li>
                    </ol>
                    <h4 class="mb-sm-3 fw-bold font-size-22 mt-3">Data Master KPI</h4>
                </div>
