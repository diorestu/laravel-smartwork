...
@section('title')
    Tambah Data Lembur Pegawai | Smartwork App
@endsection
...
<div class="main-content mx-0">
    <div class="page-title-box pb-2 d-sm-flex align-items-start justify-content-between">
        <div class="mb-3">
            ...
            <h4 class="mb-sm-0 fw-bold font-size-22 mt-3">Tambah Data Lembur Pegawai</h4>
        </div>
    </div>
                        ...
                        <div class="tab-pane active" id="overview" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title text-white mb-0">Buat Lembur Baru</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="mb-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" id="lembur_awal_tanggal" name="lembur_awal_tanggal" value="{{ date("Y-m-d") }}">
                                                </div>
                                            </div>
                                            <div class="mb-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="fas fa-calendar"></i></div>
                                                    <input type="text" class="form-control datepicker" id="lembur_akhir_tanggal" name="lembur_akhir_tanggal" value="{{ date("Y-m-d") }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="time" class="form-control" id="lembur_awal_waktu" name="lembur_awal_waktu" value="07:00">
                                                </div>
                                            </div>
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="fas fa-clock"></i></div>
                                                    <input type="time" class="form-control" id="lembur_akhir_waktu" name="lembur_akhir_waktu" value="19:00">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input required id="lembur_judul" class="form-control" type="text" name="lembur_judul">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group mb-4">
                                                <label for="lembur_keterangan" class="font-weight-bolder">Keterangan Lembur</label>
                                                <input id="lembur_keterangan" class="form-control" type="text" name="lembur_keterangan">
                                            </div>
                                        </div>
                                    </div>
                                    <button class="btn btn-success btn-block w-100 btn-md mt-3" type="submit">
                                        <i class="fas fa-plus-circle icon-md"></i>&nbsp; Tambah Lembur Baru
                                    </button>
                                </div>
                            </div>
                        </div>
