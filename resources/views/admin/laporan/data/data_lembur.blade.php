        ...
        <div class="card-body">
            <div class="dropdown float-end">
                ...
                <div class="dropdown-menu dropdown-menu-end" style="">
                    <a class="dropdown-item" href="{{ route("lapLembur.ekspor", ['u'=>$c->user->id, 's'=>$tawal, 'e'=>$takhir]) }}">Ekspor ke Excel</a>
            ...
            <div class="table-responsive mt-4">
                <table class="table rounded" id="">
                    ...
                    <tbody>
                        @php
                            $q_isi_absen = App\Models\Absensi::where('id_user', $c->id_user)
                                    ->whereBetween('jam_pulang', [$tawal, $takhir])
                                    ->whereNotNull('jam_lembur')
                                    ->get();
                        @endphp
                        ...
                        @endforeach
                        @php
                            $q_isi = App\Models\Lembur::where('id_user', $c->id_user)
                                    ->where('lembur_status', 'DITERIMA')
