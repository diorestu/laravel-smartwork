...
class AbsensiCabang implements FromView, WithEvents, WithProperties, WithStyles, WithColumnWidths, Responsable
{
    ...
    public function properties(): array
    {
        return [
            ...
            'title'          => 'Rekap Absensi Pegawai per Cabang',
            'description'    => 'Rekap Absensi Pegawai per Cabang',
            'subject'        => 'Rekap Absensi Pegawai per Cabang',
            'keywords'       => 'absensi, absensi per cabang',
            'category'       => 'Rekap Absensi Pegawai per Cabang',
    ...
    public function view(): View
    {
        ...
        return view('admin.absensi.expor_data.cabang_absen', [
            'data'      => $data,
            'cabang'    => $this->cabang,
            'awal'      => $this->awal,
            'akhir'     => $this->akhir,
